...
from kaguya.modules.sql import afk_sql as sql
from kaguya.modules.users import get_user_id

from kaguya.modules.helper_funcs.alternate import send_message
